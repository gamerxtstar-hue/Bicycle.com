...
// Shared colorable silhouette used by the live "preview a color" tool.
// (Real product photos are shown separately — see each product's `photo`.)
const BIKE_SILHOUETTE = '<path d="M40 150c22 0 40-18 40-40s-18-40-40-40-40 18-40 40 18 40 40 40zm220 0c22 0 40-18 40-40s-18-40-40-40-40 18-40 40 18 40 40 40zM40 150l60-90h50l35 70M100 60l25 40" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M155 100l-18 30h-75" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M260 150l-25-70" stroke-width="10" stroke-linecap="round" fill="none"/><circle cx="150" cy="60" r="7" fill-opacity="1"/>';
...
const CATALOG = {
  urban: {
    ...
    sizes: ['S','M','L'],
    photo: 'https://images.pexels.com/photos/12549537/pexels-photo-12549537.jpeg?w=900&q=80',
  ...
  trail: {
    ...
    sizes: ['S','M','L','XL'],
    photo: 'https://images.pexels.com/photos/90454/pexels-photo-90454.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  backcountry: {
    id: 'backcountry',
    badge: 'Trail',
    name: 'Blackline Backcountry',
    price: 1949,
    ...
    sizes: ['M','L','XL'],
    photo: 'https://images.pexels.com/photos/16082647/pexels-photo-16082647.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  race: {
    id: 'race',
    ...
    sizes: ['XS','S','M','L'],
    photo: 'https://images.pexels.com/photos/2943358/pexels-photo-2943358.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  gravel: {
    id: 'gravel',
    badge: 'Gravel',
    name: 'Blackline Gravel',
    price: 1699,
    ...
    sizes: ['S','M','L'],
    photo: 'https://images.pexels.com/photos/3599587/pexels-photo-3599587.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  heritage: {
    id: 'heritage',
    badge: 'Heritage',
    name: 'Blackline Heritage',
    price: 1049,
    tagline: 'Classic step-through silhouette with a modern drivetrain underneath.',
    ...
    sizes: ['S','M','L'],
    photo: 'https://images.pexels.com/photos/37858364/pexels-photo-37858364.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  studio: {
    id: 'studio',
    ...
    sizes: ['S','M','L'],
    photo: 'https://images.pexels.com/photos/18491459/pexels-photo-18491459.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  coastal: {
    id: 'coastal',
    badge: 'Cruiser',
    name: 'Blackline Coastal',
    price: 899,
    tagline: 'Relaxed cruiser geometry built for boardwalks and slow afternoons.',
    description: 'An easy-going cruiser with a front basket mount, swept-back bars, and a relaxed riding position built for boardwalks, not commutes.',
    specs: [['Frame weight','11.8kg'],['Drivetrain','3-speed'],['Brakes','Coaster + rim'],['Wheel size','26"'],['Finish','Custom powder-coat']],
    sizes: ['One Size'],
    photo: 'https://images.pexels.com/photos/38067899/pexels-photo-38067899.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  fold: {
    id: 'fold',
    ...
    sizes: ['One Size'],
    photo: 'https://images.pexels.com/photos/35057478/pexels-photo-35057478.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  },
  dualtone: {
    id: 'dualtone',
    badge: 'Street',
    name: 'Blackline Dual-Tone',
    price: 1349,
    ...
    sizes: ['S','M','L'],
    photo: 'https://images.pexels.com/photos/17331856/pexels-photo-17331856.jpeg?w=900&q=80',
    photoCredit: 'Photo via Pexels'
  }
};
